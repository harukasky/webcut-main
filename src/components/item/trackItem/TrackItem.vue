<template>
  <div class="text-left text-sm top-0 absolute trackItem"
    :class="[TrackHeightMap.get(props.trackItem.type), isDragState ? 'z-50 isDrag' : 'z-10']" :style="[itemClass]"
    :data-type="props.trackItem.type" :data-line="lineIndex" :data-index="itemIndex" @click="setSelectTract">
    <!-- 操作手柄 -->
...
import CharacterItem from './template/CharacterItem.vue';
