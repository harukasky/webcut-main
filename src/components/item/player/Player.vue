<template>
  <div class="p-2 absolute top-12 bottom-10 left-2 right-2 overflow-hidden">
    <canvas ref="playerCanvas" class="absolute left-0 right-0 top-0 bottom-0 m-auto bg-gray-900" id="player" :width="playerWidth" :height="playerHeight" :style="{ zoom: scale, width: `${playerWidth}px`, height: `${playerHeight}px` }" />
    <!--
