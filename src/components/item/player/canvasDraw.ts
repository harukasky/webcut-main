...
export class CanvasPlayer {
    ...
    playerContext: ImageBitmapRenderingContext | null = null;//转换为bitmap来处理这边的数据
    ...
    async drawCanvas() {
        ...
        //现在问题就是，绘制canvas，如果OffscreenCanvas失败了
        const offCanvas = new OffscreenCanvas(this.playerStore.playerWidth, this.playerStore.playerHeight);//offscreenCanvas是浏览器放出来的API，只要有现代浏览器就能够支持
